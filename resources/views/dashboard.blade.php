...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link" id="belumvldl-tab" data-toggle="tab" href="#belumvldl" role="tab" aria-controls="belumvldl" aria-selected="false">Belum di validasi</a>
      </li>
      <li class="nav-item">
  ...
  <div class="card-body">
    <h5 class="card-title">Semua Laporan</h5>
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>at</td>
                  <td>
                      <button type="button" class="btn btn-outline-warning">Lihat</button>
