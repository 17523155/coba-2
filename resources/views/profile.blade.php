...
<div class="container" >
  ...
  <form>
    ...
    <div class="form-group col-md-6">
      <div class="card">
  <img class="card-img-top" src="http://1.bp.blogspot.com/-vGwfUEcu2kk/UPLGcZJ4SSI/AAAAAAAALYw/bmllfIVBuQs/s1600/LOGO+BADAN+NASIONAL+PENANGGULANGAN+BENCANA.png" alt="Card image cap">
  <div class="card-body">
  </div>
</div>
    </div>
  ...
  <div class="form-row">
    ...
    <label for="inputPassword4">Region</label>
      <input type="text" class="form-control" id="inputPassword4" placeholder="Region Anda">
  </div>
  <div class="form-group">
