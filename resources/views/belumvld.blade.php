      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Laporan Belum di Validasi</h1>
...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link " href="/dashboard">Semua</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="/belumvld">Belum di validasi</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/sudahvld">Sudah di validasi</a>
      </li>
    </ul>
  </div>
  <div class="card-body">
    <h5 class="card-title">Laporan belum validasi</h5>
