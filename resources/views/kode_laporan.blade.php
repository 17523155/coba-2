...
<html lang="en">
  ...
  <h4 class="alert-heading">Tulis Laporan</h4><hr>
...
<!--   <hr>
  ...
  <div class="input-group-append">
    ...
    <label for="deskripsi">Keterangan Kerusakan</label>
  ...
  <button type="submit" class="btn btn-warning" data-toggle="modal" data-target="#kodelaporann">
  Kirim
</button>
</form>
          </div>
